...
<gameSystem id="28ec-711c-d87f-3aeb" name="Warhammer 40,000 8th Edition - French" revision="43" battleScribeVersion="2.01" authorName="BSData Organisation" authorContact="@BSData" authorUrl="http://battlescribedata.appspot.com/#/repo/wh40k" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <profiles/>
  <rules/>
  <infoLinks/>
  <costTypes>
  ...
  <sharedProfiles>
    ...
    <profile id="df40-a3f4-91be-f0fe" name="Melta bomb" book="" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48">
      ...
      <characteristics>
        ...
        <characteristic name="PA" characteristicTypeId="75aa-a838-b675-6484" value="-4"/>
        <characteristic name="D" characteristicTypeId="ae8a-3137-d65b-4ca7" value="D6"/>
        <characteristic name="Aptitudes" characteristicTypeId="837d-5e63-aeb7-1410" value="You can re-roll failed wound rolls for this weapon if the target is a VEHICLE."/>
      </characteristics>
    </profile>
